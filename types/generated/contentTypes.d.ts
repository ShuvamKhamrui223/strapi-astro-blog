...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    post_content: Schema.Attribute.RichText &
      ...
      Schema.Attribute.DefaultTo<'post content will go here'>;
    post_slug: Schema.Attribute.UID<'post_title'>;
    ...
    publish_date: Schema.Attribute.Date &
      ...
      Schema.Attribute.DefaultTo<'2025-04-22'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    authorEmail: Schema.Attribute.Email &
      Schema.Attribute.DefaultTo<'author@mail.com'>;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'author name'>;
...
export interface ApiCauseCause extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    causeDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    causeThumbnail: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    donateLink: Schema.Attribute.Component<'common.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    goalAmount: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    raisedAmount: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    header: Schema.Attribute.Component<'layout.top-nav', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiNewArticleNewArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    news_slug: Schema.Attribute.UID<'title'>;
    news_tags: Schema.Attribute.UID;
    newsCoverImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    publish_date: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
